  ...
  return [
    {
      ...
      amount: "$3",
      cadence: "One-time",
      description: "A small thank-you that helps keep the tools available.",
    ...
    },
    {
      ...
      amount: "$8",
      cadence: "One-time",
      description: "A larger thank-you toward hosting and AI costs.",
    ...
    },
    {
      ...
      amount: "Custom",
      cadence: "One-time",
      description: "Choose the one-time amount that feels right for your family.",
    ...
    },
    {
      ...
      amount: "$5",
      cadence: "Monthly",
      description: "Optional ongoing support for recurring hosting and AI costs.",
