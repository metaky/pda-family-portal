...
export const migrationInventory: MigrationInventoryItem[] = [
  {
    ...
    status:
      "Native MVP migrated into the portal with source-faithful prompt parity, variations, local history, privacy guardrails, mocked e2e coverage, live Gemini route support, and a source-eval spot check; full source evaluator script parity remains a pre-launch hardening task.",
    sourceFiles: [
